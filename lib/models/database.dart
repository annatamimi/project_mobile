...
import 'package:cuantrack_app/models/category.dart';
import 'package:cuantrack_app/models/transaction.dart';
...
//CRUD Category
  ...
  Future updateTransactionRepo(int id, int amount, int categoryId, DateTime transactionDate, String nameDetail) 
    async {
