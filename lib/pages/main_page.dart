...
import 'package:cuantrack_app/pages/category_page.dart';
import 'package:cuantrack_app/pages/home_page.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: (currentIndex == 0) ? CalendarAppBar(
        accent: const Color.fromARGB(255, 121, 151, 250),
        backButton: false,
      ...
      floatingActionButton: Visibility(
        ...
        backgroundColor: Color.fromARGB(255, 121, 151, 250), 
